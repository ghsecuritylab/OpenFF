...
#define ATH_NETIF_NO_BEACON     0x08
    ...
    void        (*set_beacon_config)(ieee80211_handle_t, int if_id, ieee80211_beacon_config_t *conf);
...
#define ATH_IF_ID_ANY   0xff
    ...
    int         (*listen)(ath_dev_t, int if_id, u_int flags);
...
#define ATH_ISR_NOTMINE         0x0002  /* This was not my interrupt - for shared IRQ's	*/
    ...
    u_int32_t   (*txfree_count)(ath_dev_t);
...
#endif
    void        (*set_home)(ath_dev_t dev , u_int8_t home);
...
#define ATH_RB_DEF_SKIP_THRESH  5
    ...
    u_int8_t             txrx_led;                        /* Indicate the state of TX/RX LED */
