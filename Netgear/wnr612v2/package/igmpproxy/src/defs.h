...
// to control the times of IGMP query via config file
#define IGMP_QUERY_PATCH 1
#if IGMP_QUERY_PATCH
#define IGMP_QUERY_DEFAULT_COUNT 1
#endif
...
// to check member timeout every one second
#define INTERVAL_CHECK_MEMBER 1
#endif
