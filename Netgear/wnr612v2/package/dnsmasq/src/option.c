...
#define OPTSTRING "DNLERowefnbvhdqr:m:p:c:l:s:i:t:u:g:a:x:S:C:A:T:H:Q:I:B:P:"
...
#ifdef DNI_PARENTAL_CTL
"-P, --parental-control=file Enable Parental Control and specify deviceid file(default to /tmp/parentalcontrol.conf).\n"
#endif
"\n";
      ...
      case 'P':
        {
            parentalcontrol_enable = 1;
	    			if (optarg) {
	        		pc_table_file = safe_string_alloc(optarg);
	    			}
	    break;
				}
#endif
