...
#define VERSION "1.18"
/* dns-hijack fo netgear project */
/* add by loren 03/27/2007 */
#ifndef NETGEAR_PROJECT
#define NETGEAR_PROJECT 1
#endif

#ifdef NETGEAR_PROJECT
#define HIJACK_STATUS "/tmp/configs/dns_hijack"
#define WANLAN_CONFLICT "/tmp/wan_lan_ip_conflict"
#endif
