...
#define IPT_HTTP_SITE_PROHIBITED 	9
#define IPT_NNTP_GRUP_PROHIBITED	10
#define IPT_TRAFFIC_LIMIT	11
...
static const struct reject_names reject_table[] = {
	...
	{"netgear-firewall-blocking-page","site-prohib",
	 IPT_HTTP_SITE_PROHIBITED, "HTTP site prohibited"},
	{"netgear-firewall-blocking-nntp","nntp-prohib",
	 IPT_NNTP_GRUP_PROHIBITED, "NNTP group prohibited"},
	{"netgear-traffic-meter-limit","traffic-limit",
	 IPT_TRAFFIC_LIMIT, "Traffic meter limit"}
};
