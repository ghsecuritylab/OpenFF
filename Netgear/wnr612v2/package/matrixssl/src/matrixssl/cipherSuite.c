...
/******************************************************************************/
static int32 csNullCryptPub(psPool_t *pool, psPubKey_t *key, 
			unsigned char *in, uint32 inlen, unsigned char *out, uint32 outlen)
{
	if (inlen <= outlen) {
		psTraceInfo("Error: output buffer too small for NULL encrypt\n");
...
static int32 csRsaEncryptPub(psPool_t *pool, psPubKey_t *key, 
			unsigned char *in, uint32 inlen, unsigned char *out, uint32 outlen)
{
...
static int32 csRsaDecryptPub(psPool_t *pool, psPubKey_t *key, 
			unsigned char *in, uint32 inlen, unsigned char *out, uint32 outlen)
{
	psAssert(key->type == PS_RSA);
...
static int32 csRsaEncryptPriv(psPool_t *pool, psPubKey_t *key, 
			unsigned char *in, uint32 inlen, unsigned char *out, uint32 outlen)
{
	return PS_UNSUPPORTED_FAIL;
}

static int32 csRsaDecryptPriv(psPool_t *pool, psPubKey_t *key, 
			unsigned char *in, uint32 inlen, unsigned char *out, uint32 outlen)
{
	psAssert(key->type == PS_RSA);
...
*/
int32 sslGetCipherSpecList(unsigned char *c, int32 len, int32 addScsv)
{
	unsigned char	*end, *p;
	unsigned short	i;
