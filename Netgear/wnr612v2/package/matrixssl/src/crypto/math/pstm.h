...
extern int32 pstm_count_bits (pstm_int * a);
...
extern int32 pstm_grow(pstm_int * a, int32 size);
...
extern void pstm_rshd(pstm_int *a, int32 x);

extern int32 pstm_lshd(pstm_int * a, int32 b);

extern int32 pstm_div(psPool_t *pool, pstm_int *a, pstm_int *b, pstm_int *c,
				pstm_int *d);
				
extern int32 pstm_div_2d(psPool_t *pool, pstm_int *a, int32 b, pstm_int *c,
				pstm_int *d);
...
extern int32 pstm_2expt(pstm_int *a, int32 b);				
