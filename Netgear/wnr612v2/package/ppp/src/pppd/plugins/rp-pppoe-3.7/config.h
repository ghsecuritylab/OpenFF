...
/* Supports many server in the identical network   */
#define MORE_PPPOE_SERVER   1

#define NETGEAR_ROUTER_SPEC 1
#if (NETGEAR_ROUTER_SPEC)
#define LAST_ID_FILE "/dev/mtdblock4"
#define BLOCK_SIZE (64*1024)
#define BUFFER_SIZE 512
#define BUFFER_OFFSET (BLOCK_SIZE-BUFFER_SIZE)
int clean_session_id;
#endif
