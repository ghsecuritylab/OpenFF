...
#define detcable_trivial_usage "None"
#define detcable_full_usage "None"
...
#define my_print_trivial_usage	"None"
#define my_print_full_usage	"None"
...
#define pingdet_trivial_usage \
	"[OPTION]... host"
#define pingdet_full_usage \
	"Send ICMP ECHO_REQUEST packets to network hosts.\n\n" \
	"Options:\n" \
	"\t-c COUNT\tSend only COUNT pings.\n" \
	"\t-s SIZE\t\tSend SIZE data bytes in packets (default=56).\n" \
...
#define wanwd_trivial_usage	"None"
#define wanwd_full_usage	"None"	
