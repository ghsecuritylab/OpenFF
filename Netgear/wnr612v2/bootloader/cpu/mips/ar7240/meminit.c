...
ar7240_ddr_initial_config(uint32_t refresh)
{
...
#endif
    {
       ...
       {
	    ddr_config = CFG_7241_DDR_CONFIG_VAL;
	    ddr_config2 = CFG_7241_DDR_CONFIG2_VAL;
	    ext_mod = CFG_7241_DDR_EXT_MODE_VAL;
            ddr2_ext_mod = CFG_DDR2_EXT_MODE_VAL;
            mod_val_init = CFG_7241_DDR_MODE_VAL_INIT;
            mod_val = CFG_7241_DDR_MODE_VAL;
        }
        else 
#endif
        {
