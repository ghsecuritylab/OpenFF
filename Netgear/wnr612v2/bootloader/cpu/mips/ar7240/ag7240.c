...
ag7240_send(struct eth_device *dev, volatile void *packet, int length)
{
	...
	// Added by wayne on 2009/11/09 for LAN LED lighting
	ag7240_phy_link(mac->mac_unit, link, duplex, speed); /* add by alfa */
...
if ((ar7240_reg_rd(AR7240_REV_ID) & AR7240_REV_ID_MASK) == AR7240_REV_1_2) {
    ...
    ag7240_reg_wr(mac, AG7240_MAC_FIFO_CFG_5, 0x7ebcf);
#else
...
#if defined(CONFIG_WNR612) || defined(CONFIG_WNR1100)
    udelay(1000 * 1000);
#endif
