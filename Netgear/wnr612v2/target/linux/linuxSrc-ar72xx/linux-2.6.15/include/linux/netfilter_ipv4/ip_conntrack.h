...
struct ip_conntrack
{
    ...
    defined(CONFIG_IP_NF_TARGET_SNATP2P)
		char masq_ifname[IFNAMSIZ];
#endif
	} nat;
...
#if  defined(CONFIG_IP_NF_SIP_MODULE ) || defined(CONFIG_IP_NF)
	struct dnisip_branch_info *dnisip_branch;
	int mangle_contact;
