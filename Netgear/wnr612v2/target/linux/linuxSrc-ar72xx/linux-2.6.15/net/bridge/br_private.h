...
#define IPTV
extern void iptv_igmp_init(void);
extern void iptv_igmp_shutdown(void);
...
static inline void br_timer_set(struct br_timer *t, unsigned long x)
{
...
static inline void br_timer_clear(struct br_timer *t)
{
