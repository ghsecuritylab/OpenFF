 ...
 *
 *	$Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/net/bridge/br_private_stp.h#1 $
 *
...
#ifdef IPTV
static inline int br_timer_has_expired(struct br_timer *t, unsigned long to)
{
	return t->running && time_after_eq(jiffies, t->expires + to);
}

extern char cBrgName[16];
