 ...
 *
 * Version:	$Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/net/ipv4/fib_frontend.c#1 $
 *
...
extern void inet_route_event(unsigned int cmd, struct rtentry *rt);
#endif
