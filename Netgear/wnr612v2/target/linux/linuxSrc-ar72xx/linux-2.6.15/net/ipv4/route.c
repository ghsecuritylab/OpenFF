 ...
 *
 * Version:	$Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/net/ipv4/route.c#1 $
 *
 * Authors:	Ross Biro
...
#define	MROUTE_PATCH	1	/* no validate_source check needed */
...
#if MROUTE_PATCH	/* no validate_source check needed */
	}else
		spec_dst = inet_select_addr(dev, 0, RT_SCOPE_LINK);
#else
