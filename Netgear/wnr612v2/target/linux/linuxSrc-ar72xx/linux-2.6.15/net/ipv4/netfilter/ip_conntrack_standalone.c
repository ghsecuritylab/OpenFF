...
extern atomic_t ip_conntrack_icmp_reserve_count;
extern atomic_t ip_conntrack_tcp_reserve_count;
#endif
...
static int ct_seq_show(struct seq_file *s, void *v)
{
	...
	if (conntrack->status & IPS_NAT_MASK) {
		if (seq_printf(s, "[NATed] "))
			return -ENOSPC;
	} else {
		if (seq_printf(s, "[Local] "))
			return -ENOSPC;
	}
#endif
...
static int internet_seq_show(struct seq_file *s, void *v)
{
	...
	struct ip_conntrack_tuple_hash *hash = v;

	if (DIRECTION(hash) != IP_CT_DIR_ORIGINAL)
		return 0;

	conntrack = tuplehash_to_ctrack(hash);
	if (!(conntrack->status & IPS_NAT_MASK))
		return 0;
	...
	rtuple = &conntrack->tuplehash[IP_CT_DIR_REPLY].tuple;
	...
	if (conntrack->status & IPS_SRC_NAT) {
		 ...
		 */
		if (otuple->dst.ip == rtuple->src.ip)
			return 0;
...
static int internet_open(struct inode *inode, struct file *file)
{
	...
	if (st == NULL)
		return -ENOMEM;
	ret = seq_open(file, &internet_seq_ops);
	if (ret)
		goto out_free;
...
/* From ip_REJECT.c*/
extern int ip_send_log_email;

/* From ip_conntrack_core.c */
extern int ip_conntrack_max;
extern unsigned int ip_conntrack_htable_size;
#if defined(CONFIG_IP_NF_CT_NAT_RESERVE)
extern int ip_conntrack_icmp_reserve_max;
extern int ip_conntrack_tcp_reserve_max;
#endif
...
extern int ip_ct_tcp_forward_accept;
...
static ctl_table ip_ct_sysctl_table[] = {
...
#if defined(CONFIG_IP_NF_CT_NAT_RESERVE)
       {
               .ctl_name       = NET_IPV4_NF_CONNTRACK_ICMP_RESERVE_MAX,
               .procname       = "ip_conntrack_icmp_reserve_max",
               .data           = &ip_conntrack_icmp_reserve_max,
               .maxlen         = sizeof(int),
               .mode           = 0644,
               .proc_handler   = &proc_dointvec,
       },
       {
               .ctl_name       = NET_IPV4_NF_CONNTRACK_ICMP_RESERVE_COUNT,
               .procname       = "ip_conntrack_icmp_reserve_count",
               .data           = &ip_conntrack_icmp_reserve_count,
               .maxlen         = sizeof(int),
               .mode           = 0444,
               .proc_handler   = &proc_dointvec,
       },
       {
               .ctl_name       = NET_IPV4_NF_CONNTRACK_TCP_RESERVE_MAX,
               .procname       = "ip_conntrack_tcp_reserve_max",
               .data           = &ip_conntrack_tcp_reserve_max,
               .maxlen         = sizeof(int),
               .mode           = 0644,
               .proc_handler   = &proc_dointvec,
       },
       {
               .ctl_name       = NET_IPV4_NF_CONNTRACK_TCP_RESERVE_COUNT,
               .procname       = "ip_conntrack_tcp_reserve_count",
               .data           = &ip_conntrack_tcp_reserve_count,
               .maxlen         = sizeof(int),
               .mode           = 0444,
               .proc_handler   = &proc_dointvec,
       },
	...
	{
                .ctl_name       = NET_IPV4_NF_CONNTRACK_TCP_FORWARD_ACCEPT,
                .procname       = "ip_conntrack_tcp_forward_accept",
                .data           = &ip_ct_tcp_forward_accept,
                .maxlen         = sizeof(unsigned int),
                .mode           = 0644,
                .proc_handler   = &proc_dointvec,
        },
	...
	{
		.ctl_name	= NET_IPV4_NF_SEND_LOG_EMAIL,
		.procname	= "ip_send_log_email",
		.data		= &ip_send_log_email,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec,
	},
...
#if defined(CONFIG_IP_NF_CT_NAT_RESERVE)
#define NET_IP_CONNTRACK_ICMP_RESERVE_MAX 2090
#define NET_IP_CONNTRACK_TCP_RESERVE_MAX 2091
#define NET_IP_CONNTRACK_ICMP_RESERVE_COUNT 2092
#define NET_IP_CONNTRACK_TCP_RESERVE_COUNT 2093
#endif
...
static ctl_table ip_ct_netfilter_table[] = {
	...
	},
	{
...
#if defined(CONFIG_IP_NF_CT_NAT_RESERVE)
       {
               .ctl_name       = NET_IP_CONNTRACK_ICMP_RESERVE_MAX,
               .procname       = "ip_conntrack_icmp_reserve_max",
               .data           = &ip_conntrack_icmp_reserve_max,
               .maxlen         = sizeof(int),
               .mode           = 0644,
       ...
       {
               .ctl_name       = NET_IP_CONNTRACK_TCP_RESERVE_MAX,
               .procname       = "ip_conntrack_tcp_reserve_max",
               .data           = &ip_conntrack_tcp_reserve_max,
               .maxlen         = sizeof(int),
               .mode           = 0644,
       ...
       {
               .ctl_name       = NET_IP_CONNTRACK_ICMP_RESERVE_COUNT,
               .procname       = "ip_conntrack_icmp_reserve_count",
               .data           = &ip_conntrack_icmp_reserve_count,
               .maxlen         = sizeof(int),
               .mode           = 0644,
       ...
       {
               .ctl_name       = NET_IP_CONNTRACK_TCP_RESERVE_COUNT,
               .procname       = "ip_conntrack_tcp_reserve_count",
               .data           = &ip_conntrack_tcp_reserve_count,
               .maxlen         = sizeof(int),
               .mode           = 0644,
...
static int init_or_cleanup(int init)
{
	...
	#if defined(CONFIG_IP_NF_CT_NAT_SESSION)
	if (proc_net_fops_create("ip_conntrack_scan", 0440, &internet_file_ops) == NULL)
